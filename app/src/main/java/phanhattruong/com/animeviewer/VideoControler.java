...
public class VideoControler extends MediaController {
    ...
    public void setAnchorView(View view) {
        ...
        fullScreen.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(),AnimeViewActivity.class);
        ...
        Log.d("FULL SCREEN", "is full screen"+ isFullScreen );
    }
}
